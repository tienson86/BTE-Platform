...
class DirectoryValidator:
    ...
    def collect_json_files(
        ...
        # Validate authoritative fixtures only — skip generated outputs and
        # tooling artifacts (actual/, reports/, root schema copies, manifests).
        skip_parts = {
            ACTUAL_FOLDER,
            REPORTS_FOLDER,
            SCHEMA_FOLDER,
        ...
        for file in sorted(
            ...
            # Skip loose files in the dataset root (manifests, schema copies).
            if file.parent == self.dataset_root:
                continue
