# Heavenly Stems — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Heavenly Stems**.
...
Provide a stable domain boundary for **Heavenly Stems** so authors can:
...
- Framework records for Heavenly Stems concepts
...
- Downstream Rule Database and Sentence Library domains for Heavenly Stems topics
...
- This domain owns only **Heavenly Stems** framework placement under `knowledge/knowledge_canon/02_heavenly_stems/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `02_heavenly_stems` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000100 – KNO-000199` |
| Next Free ID | **KNO-000100** |
