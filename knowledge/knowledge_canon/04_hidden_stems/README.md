# Hidden Stems — Knowledge Canon Domain

**Module:** `knowledge/knowledge_canon`  
**Domain:** `04_hidden_stems`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `KNO` records related to **Hidden Stems**.
...
Provide a stable domain boundary for **Hidden Stems** so authors can:
...
- Framework records for Hidden Stems concepts
...
- Downstream Rule Database and Sentence Library domains for Hidden Stems topics
...
- This domain owns only **Hidden Stems** framework placement under `knowledge/knowledge_canon/04_hidden_stems/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `04_hidden_stems` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000300 – KNO-000399` |
| Next Free ID | **KNO-000300** |
