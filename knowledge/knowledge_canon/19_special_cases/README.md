# Special Cases — Knowledge Canon Domain

**Module:** `knowledge/knowledge_canon`  
**Domain:** `19_special_cases`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `KNO` records related to **Special Cases**.
...
- Framework records for Special Cases concepts
...
- Downstream Rule Database and Sentence Library domains for Special Cases topics
...
- This domain owns only **Special Cases** framework placement under `knowledge/knowledge_canon/19_special_cases/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `19_special_cases` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-001900 – KNO-001999` |
| Next Free ID | **KNO-001900** |
