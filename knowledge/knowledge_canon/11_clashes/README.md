# Clashes — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Clashes**.
...
Provide a stable domain boundary for **Clashes** so authors can:
...
- Framework records for Clashes concepts
...
- Downstream Rule Database and Sentence Library domains for Clashes topics
...
- This domain owns only **Clashes** framework placement under `knowledge/knowledge_canon/11_clashes/`.
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-001000 – KNO-001099` |
| Next Free ID | **KNO-001000** |
