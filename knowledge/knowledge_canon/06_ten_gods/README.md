# Ten Gods — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Ten Gods**.
...
Provide a stable domain boundary for **Ten Gods** so authors can:
...
- Framework records for Ten Gods concepts
...
- Downstream Rule Database and Sentence Library domains for Ten Gods topics
...
- This domain owns only **Ten Gods** framework placement under `knowledge/knowledge_canon/06_ten_gods/`.
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000500 – KNO-000599` |
| Next Free ID | **KNO-000500** |
