# Yin Yang — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Yin Yang**.
...
Provide a stable domain boundary for **Yin Yang** so authors can:
...
- Framework records for Yin Yang concepts
...
- Downstream Rule Database and Sentence Library domains for Yin Yang topics
...
- This domain owns only **Yin Yang** framework placement under `knowledge/knowledge_canon/05_yin_yang/`.
