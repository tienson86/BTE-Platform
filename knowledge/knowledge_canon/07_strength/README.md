# Strength — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Strength**.
...
Provide a stable domain boundary for **Strength** so authors can:
...
- Framework records for Strength concepts
...
- Downstream Rule Database and Sentence Library domains for Strength topics
...
- This domain owns only **Strength** framework placement under `knowledge/knowledge_canon/07_strength/`.
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000600 – KNO-000699` |
| Next Free ID | **KNO-000600** |
