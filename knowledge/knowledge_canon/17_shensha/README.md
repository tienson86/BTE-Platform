# Shensha — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Shensha**.
...
Provide a stable domain boundary for **Shensha** so authors can:
...
- Framework records for Shensha concepts
...
- Downstream Rule Database and Sentence Library domains for Shensha topics
...
- This domain owns only **Shensha** framework placement under `knowledge/knowledge_canon/17_shensha/`.
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-001600 – KNO-001799` |
| Next Free ID | **KNO-001600** |
