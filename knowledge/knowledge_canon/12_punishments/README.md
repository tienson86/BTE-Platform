# Punishments — Knowledge Canon Domain

**Module:** `knowledge/knowledge_canon`  
**Domain:** `12_punishments`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `KNO` records related to **Punishments**.
...
Provide a stable domain boundary for **Punishments** so authors can:
...
- Framework records for Punishments concepts
...
- Downstream Rule Database and Sentence Library domains for Punishments topics
...
- This domain owns only **Punishments** framework placement under `knowledge/knowledge_canon/12_punishments/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `12_punishments` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-001100 – KNO-001199` |
| Next Free ID | **KNO-001100** |
