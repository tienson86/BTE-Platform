# Canon Registry — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Canon Registry**.
...
Provide a stable domain boundary for **Canon Registry** so authors can:
...
- Locator rows for Knowledge Assets across Canon domains
- Registry index scaffolding
...
- Root specification: `knowledge/knowledge_canon/KNOWLEDGE_SPEC.md`
- All Knowledge Canon domain indexes
...
- Complements Global Knowledge Registry
...
- This domain owns only **Canon Registry** framework placement under `knowledge/knowledge_canon/registry/`.
