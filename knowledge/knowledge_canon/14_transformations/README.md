# Transformations Knowledge Domain
...
Hold Knowledge Assets for the **Transformations** domain within the BTE Knowledge Canon.
...
Next free ID for this domain: **KNO-001300**
