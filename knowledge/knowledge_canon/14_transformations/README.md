# Transformations — Knowledge Canon Domain

**Module:** `knowledge/knowledge_canon`  
**Domain:** `14_transformations`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `KNO` records related to **Transformations**.
...
Provide a stable domain boundary for **Transformations** so authors can:
...
- Framework records for Transformations concepts
...
- Downstream Rule Database and Sentence Library domains for Transformations topics
...
- This domain owns only **Transformations** framework placement under `knowledge/knowledge_canon/14_transformations/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `14_transformations` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-001300 – KNO-001399` |
| Next Free ID | **KNO-001300** |
