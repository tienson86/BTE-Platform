# Patterns — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Patterns**.
...
- Framework records for Patterns concepts
...
- Downstream Rule Database and Sentence Library domains for Patterns topics
...
- This domain owns only **Patterns** framework placement under `knowledge/knowledge_canon/08_patterns/`.
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000700 – KNO-000799` |
| Next Free ID | **KNO-000700** |
