# Combinations — Knowledge Canon Domain
...
It holds indexes and templates for future `KNO` records related to **Combinations**.
...
Provide a stable domain boundary for **Combinations** so authors can:
...
- Framework records for Combinations concepts
...
- Downstream Rule Database and Sentence Library domains for Combinations topics
...
- This domain owns only **Combinations** framework placement under `knowledge/knowledge_canon/10_combinations/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `10_combinations` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000900 – KNO-000999` |
| Next Free ID | **KNO-000900** |
