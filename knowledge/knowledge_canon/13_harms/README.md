...
It holds indexes and templates for future `KNO` records related to **Harms**.
...
Provide a stable domain boundary for **Harms** so authors can:
...
- Framework records for Harms concepts
...
- Downstream Rule Database and Sentence Library domains for Harms topics
...
- This domain owns only **Harms** framework placement under `knowledge/knowledge_canon/13_harms/`.
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-001200 – KNO-001299` |
| Next Free ID | **KNO-001200** |
