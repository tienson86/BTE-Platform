# Seasonal Qi — Knowledge Canon Domain

**Module:** `knowledge/knowledge_canon`  
**Domain:** `15_seasonal_qi`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `KNO` records related to **Seasonal Qi**.
...
Provide a stable domain boundary for **Seasonal Qi** so authors can:
...
- Framework records for Seasonal Qi concepts
...
- Downstream Rule Database and Sentence Library domains for Seasonal Qi topics
...
- This domain owns only **Seasonal Qi** framework placement under `knowledge/knowledge_canon/15_seasonal_qi/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `15_seasonal_qi` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-001400 – KNO-001499` |
| Next Free ID | **KNO-001400** |
