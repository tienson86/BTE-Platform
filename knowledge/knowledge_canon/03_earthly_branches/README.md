# Earthly Branches — Knowledge Canon Domain

**Module:** `knowledge/knowledge_canon`  
**Domain:** `03_earthly_branches`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `KNO` records related to **Earthly Branches**.
...
Provide a stable domain boundary for **Earthly Branches** so authors can:
...
- Framework records for Earthly Branches concepts
...
- Downstream Rule Database and Sentence Library domains for Earthly Branches topics
...
- This domain owns only **Earthly Branches** framework placement under `knowledge/knowledge_canon/03_earthly_branches/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `03_earthly_branches` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000200 – KNO-000299` |
| Next Free ID | **KNO-000200** |
