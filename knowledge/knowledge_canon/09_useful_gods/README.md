# Useful Gods — Knowledge Canon Domain

**Module:** `knowledge/knowledge_canon`  
**Domain:** `09_useful_gods`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `KNO` records related to **Useful Gods**.
...
Provide a stable domain boundary for **Useful Gods** so authors can:
...
- Framework records for Useful Gods concepts
...
- Downstream Rule Database and Sentence Library domains for Useful Gods topics
...
- This domain owns only **Useful Gods** framework placement under `knowledge/knowledge_canon/09_useful_gods/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `09_useful_gods` |
...
|-------|-------|
| ID Prefix | `KNO` |
| Reserved Range | `KNO-000800 – KNO-000899` |
| Next Free ID | **KNO-000800** |
