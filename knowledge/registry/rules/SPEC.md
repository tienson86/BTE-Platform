...
Define the global registry contract for **Rules Registry**.
...
| Layer | Role |
|-------|------|
| Source module (`knowledge/rule_database/`) | Authoritative record |
