# Rules Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `RUL` records related to **Rules Registry**.
...
Provide a stable domain boundary for **Rules Registry** so authors can:
...
- Global locator scaffolding for Rules Registry
...
- Root specification: `knowledge/registry/README.md`
- Source module: `knowledge/rule_database/`
...
- This domain owns only **Rules Registry** framework placement under `knowledge/registry/rules/`.
