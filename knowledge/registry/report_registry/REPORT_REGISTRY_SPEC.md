# Report Registry Specification

> **Document ID:** REG-RPT-SPEC-001
>
> **Module:** `knowledge/registry/report_registry`
>
> **Version:** V1.0.0
>
> **Status:** Official
...
This specification defines the `report_registry` domain within the BTE Registry.

It catalogs metadata for objects identified by `RPT-NNNNNN`.
...
- Provide a stable metadata catalog for `RPT-*` objects
...
- Registry metadata records (`PREG-*`)
- Domain indexes
- Schema conformance
...
- Authoritative content in `knowledge/report_templates/`
...
| Field | Value |
|-------|-------|
| Registry Prefix | `PREG` |
| Object ID Prefix | `RPT` |
| Sequence Format | 6 digits |
| Example Registry ID | `PREG-000001` |
| Example Object ID | `RPT-000001` |
...
{
  "version": "1.0.0",
  "registry_name": "report_registry",
  "registry_prefix": "PREG",
  "description": "...",
...
- TODO: Root Registry specs do not enumerate dedicated Report index files. Minimal classification indexes are provided pending Chief Architect confirmation.
- TODO: Confirm Report Registry prefix `PREG` vs alternative naming (REGISTRY_ID_STANDARD lists PREG for Report Registry).
...
This registry registers objects from `knowledge/report_templates/` and may declare dependencies on other Registry Records.
...
Every `RPT-*` object SHALL be registered before becoming available to production systems.
