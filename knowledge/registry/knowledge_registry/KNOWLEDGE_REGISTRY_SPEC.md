...
> **Document ID:** REG-KNO-SPEC-001
>
> **Module:** `knowledge/registry/knowledge_registry`
>
> **Version:** V1.0.0
>
> **Status:** Official
...
This specification defines the `knowledge_registry` domain within the BTE Registry.

It catalogs metadata for objects identified by `KNO-NNNNNN`.
...
- Provide a stable metadata catalog for `KNO-*` objects
...
- Registry metadata records (`KREG-*`)
- Domain indexes
- Schema conformance
...
- Authoritative content in `knowledge/knowledge_canon/`
...
| Field | Value |
|-------|-------|
| Registry Prefix | `KREG` |
| Object ID Prefix | `KNO` |
| Sequence Format | 6 digits |
| Example Registry ID | `KREG-000001` |
| Example Object ID | `KNO-000001` |
...
This registry registers objects from `knowledge/knowledge_canon/` and may declare dependencies on other Registry Records.
...
Every `KNO-*` object SHALL be registered before becoming available to production systems.
