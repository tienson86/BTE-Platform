# Datasets Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `CASE` records related to **Datasets Registry**.
...
Provide a stable domain boundary for **Datasets Registry** so authors can:
...
- Global locator scaffolding for Datasets Registry
...
- Root specification: `knowledge/registry/README.md`
- Source module: `knowledge/golden_dataset/`
...
- This domain owns only **Datasets Registry** framework placement under `knowledge/registry/datasets/`.
