# Reports Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `RPT` records related to **Reports Registry**.
...
Provide a stable domain boundary for **Reports Registry** so authors can:
...
- Global locator scaffolding for Reports Registry
...
- Root specification: `knowledge/registry/README.md`
- Source module: `knowledge/report_templates/`
...
- This domain owns only **Reports Registry** framework placement under `knowledge/registry/reports/`.
