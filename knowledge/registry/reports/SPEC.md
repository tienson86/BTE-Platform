# Reports Registry Specification
...
Define the global registry contract for **Reports Registry**.
...
| Layer | Role |
|-------|------|
| Source module (`knowledge/report_templates/`) | Authoritative record |
