# Knowledge Assets Registry Specification
...
Define the global registry contract for **Knowledge Assets Registry**.
...
| Layer | Role |
|-------|------|
| Source module (`knowledge/knowledge_canon/`) | Authoritative record |
