# Knowledge Assets Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `KNO` records related to **Knowledge Assets Registry**.
...
Provide a stable domain boundary for **Knowledge Assets Registry** so authors can:
...
- Global locator scaffolding for Knowledge Assets Registry
...
- Root specification: `knowledge/registry/README.md`
- Source module: `knowledge/knowledge_canon/`
...
- This domain owns only **Knowledge Assets Registry** framework placement under `knowledge/registry/knowledge_assets/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `knowledge_assets` |
