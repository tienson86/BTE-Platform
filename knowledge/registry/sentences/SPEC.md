# Sentences Registry Specification
...
Define the global registry contract for **Sentences Registry**.
...
| Layer | Role |
|-------|------|
| Source module (`knowledge/sentence_library/`) | Authoritative record |
