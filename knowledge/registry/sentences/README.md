# Sentences Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `SEN` records related to **Sentences Registry**.
...
Provide a stable domain boundary for **Sentences Registry** so authors can:
...
- Global locator scaffolding for Sentences Registry
...
- Root specification: `knowledge/registry/README.md`
- Source module: `knowledge/sentence_library/`
...
- This domain owns only **Sentences Registry** framework placement under `knowledge/registry/sentences/`.
