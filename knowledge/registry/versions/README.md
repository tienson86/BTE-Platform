# Versions Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `Asset+Version` records related to **Versions Registry**.
...
Provide a stable domain boundary for **Versions Registry** so authors can:
...
- Global locator scaffolding for Versions Registry
...
- This domain owns only **Versions Registry** framework placement under `knowledge/registry/versions/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `versions` |
| Record files (future) | `Asset+Version-NNNNNN_<ENGLISH_SNAKE>.md` |
