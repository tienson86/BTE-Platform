# Terminology Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `TERM` records related to **Terminology Registry**.
...
Provide a stable domain boundary for **Terminology Registry** so authors can:
...
- Global locator scaffolding for Terminology Registry
...
- Root specification: `knowledge/registry/README.md`
- Source module: `knowledge/terminology/`
...
- This domain owns only **Terminology Registry** framework placement under `knowledge/registry/terminology/`.
