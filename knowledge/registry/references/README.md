# References Registry — Global Knowledge Registry Domain
...
It holds indexes and templates for future `REF` records related to **References Registry**.
...
Provide a stable domain boundary for **References Registry** so authors can:
...
- Global locator scaffolding for References Registry
...
- Root specification: `knowledge/registry/README.md`
- Source module: `knowledge/references/`
...
- This domain owns only **References Registry** framework placement under `knowledge/registry/references/`.
