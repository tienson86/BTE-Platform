# Shensha — Sentence Library Framework Domain
...
It holds indexes and templates for future `SEN` records related to **Shensha**.
...
- Sentence template scaffolding for Shensha
...
- This domain owns only **Shensha** framework placement under `knowledge/sentence_library/10_shensha/`.
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000900 – SEN-001099` |
| Next Free ID | **SEN-000900** |
