# Heavenly Stems — Sentence Library Framework Domain

**Module:** `knowledge/sentence_library`  
**Domain:** `03_heavenly_stems`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `SEN` records related to **Heavenly Stems**.
...
- Sentence template scaffolding for Heavenly Stems
...
- This domain owns only **Heavenly Stems** framework placement under `knowledge/sentence_library/03_heavenly_stems/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `03_heavenly_stems` |
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000200 – SEN-000299` |
| Next Free ID | **SEN-000200** |
