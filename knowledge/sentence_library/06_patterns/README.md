# Patterns — Sentence Library Framework Domain
...
It holds indexes and templates for future `SEN` records related to **Patterns**.
...
- Sentence template scaffolding for Patterns
...
- This domain owns only **Patterns** framework placement under `knowledge/sentence_library/06_patterns/`.
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000500 – SEN-000599` |
| Next Free ID | **SEN-000500** |
