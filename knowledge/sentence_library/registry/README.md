# Sentence Registry — Sentence Library Framework Domain
...
It holds indexes and templates for future `SEN` records related to **Sentence Registry**.
...
Provide a stable domain boundary for **Sentence Registry** so authors can:
...
- Locator rows for Sentences across domains
...
- Root specification: `knowledge/sentence_library/SENTENCE_LIBRARY_SPEC.md`
- All Sentence Library domain indexes
...
- This domain owns only **Sentence Registry** framework placement under `knowledge/sentence_library/registry/`.
