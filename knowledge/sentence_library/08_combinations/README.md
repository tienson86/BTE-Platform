# Combinations — Sentence Library Framework Domain

**Module:** `knowledge/sentence_library`  
**Domain:** `08_combinations`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `SEN` records related to **Combinations**.
...
- Sentence template scaffolding for Combinations
...
- This domain owns only **Combinations** framework placement under `knowledge/sentence_library/08_combinations/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `08_combinations` |
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000700 – SEN-000799` |
| Next Free ID | **SEN-000700** |
