# Earthly Branches — Sentence Library Framework Domain

**Module:** `knowledge/sentence_library`  
**Domain:** `04_earthly_branches`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `SEN` records related to **Earthly Branches**.
...
- Sentence template scaffolding for Earthly Branches
...
- This domain owns only **Earthly Branches** framework placement under `knowledge/sentence_library/04_earthly_branches/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `04_earthly_branches` |
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000300 – SEN-000399` |
| Next Free ID | **SEN-000300** |
