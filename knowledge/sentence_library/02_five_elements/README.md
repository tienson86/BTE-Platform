# Five Elements — Sentence Library Framework Domain
...
It holds indexes and templates for future `SEN` records related to **Five Elements**.
...
- Sentence template scaffolding for Five Elements
...
- This domain owns only **Five Elements** framework placement under `knowledge/sentence_library/02_five_elements/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `02_five_elements` |
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000100 – SEN-000199` |
| Next Free ID | **SEN-000100** |
