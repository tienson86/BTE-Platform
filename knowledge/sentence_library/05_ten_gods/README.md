# Ten Gods — Sentence Library Framework Domain
...
It holds indexes and templates for future `SEN` records related to **Ten Gods**.
...
- Sentence template scaffolding for Ten Gods
...
- This domain owns only **Ten Gods** framework placement under `knowledge/sentence_library/05_ten_gods/`.
