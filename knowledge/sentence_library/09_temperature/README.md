# Temperature — Sentence Library Framework Domain
...
It holds indexes and templates for future `SEN` records related to **Temperature**.
...
- Sentence template scaffolding for Temperature
...
- This domain owns only **Temperature** framework placement under `knowledge/sentence_library/09_temperature/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `09_temperature` |
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000800 – SEN-000899` |
| Next Free ID | **SEN-000800** |
