# Strength — Sentence Library Framework Domain
...
It holds indexes and templates for future `SEN` records related to **Strength**.
...
- Sentence template scaffolding for Strength
...
- This domain owns only **Strength** framework placement under `knowledge/sentence_library/01_strength/`.
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000001 – SEN-000099` |
| Next Free ID | **SEN-000001** |
