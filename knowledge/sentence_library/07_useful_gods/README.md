# Useful Gods — Sentence Library Framework Domain

**Module:** `knowledge/sentence_library`  
**Domain:** `07_useful_gods`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `SEN` records related to **Useful Gods**.
...
- Sentence template scaffolding for Useful Gods
...
- This domain owns only **Useful Gods** framework placement under `knowledge/sentence_library/07_useful_gods/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `07_useful_gods` |
...
|-------|-------|
| ID Prefix | `SEN` |
| Reserved Range | `SEN-000600 – SEN-000699` |
| Next Free ID | **SEN-000600** |
