# ShenSha Knowledge Quality Standard
...
This document defines measurable quality criteria for ShenSha Knowledge.
...
| Criterion | Focus |
|-----------|-------|
| Coverage | All V1.0 ShenSha dimensions and term families are populated |
...
ShenSha Engine must not hard-code patches for defective ShenSha knowledge.
