"""Registry search over registry domains, namespaces, and object types."""
...
class RegistrySearch:
    """Search registry inventory documents."""

    def __init__(self, documents: list[SearchDocument]) -> None:
        """Initialize with registry-kind documents."""
        self.documents = [doc for doc in documents if doc.kind.startswith("registry")]
    ...
    def search(
        ...
        *,
        ...
        """Search registry domains/namespaces/object types."""
        hits: list[SearchHit] = []
