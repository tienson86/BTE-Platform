# Career — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Career**.
...
Provide a stable domain boundary for **Career** so authors can:
...
- Report template scaffolding for Career audience/theme
...
- This domain owns only **Career** framework placement under `knowledge/report_templates/05_career/`.
...
|-------|-------|
| ID Prefix | `RPT` |
| Reserved Range | `RPT-000400 – RPT-000499` |
| Next Free ID | **RPT-000400** |
