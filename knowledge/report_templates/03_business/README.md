# Business — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Business**.
...
Provide a stable domain boundary for **Business** so authors can:
...
- Report template scaffolding for Business audience/theme
...
- This domain owns only **Business** framework placement under `knowledge/report_templates/03_business/`.
...
|-------|-------|
| ID Prefix | `RPT` |
| Reserved Range | `RPT-000200 – RPT-000299` |
| Next Free ID | **RPT-000200** |
