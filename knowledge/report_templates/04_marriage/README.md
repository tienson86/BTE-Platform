# Marriage — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Marriage**.
...
Provide a stable domain boundary for **Marriage** so authors can:
...
- Report template scaffolding for Marriage audience/theme
...
- This domain owns only **Marriage** framework placement under `knowledge/report_templates/04_marriage/`.
...
|-------|-------|
| ID Prefix | `RPT` |
| Reserved Range | `RPT-000300 – RPT-000399` |
| Next Free ID | **RPT-000300** |
