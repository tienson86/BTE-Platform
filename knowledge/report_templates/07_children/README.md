# Children — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Children**.
...
Provide a stable domain boundary for **Children** so authors can:
...
- Report template scaffolding for Children audience/theme
...
- This domain owns only **Children** framework placement under `knowledge/report_templates/07_children/`.
...
|-------|-------|
| ID Prefix | `RPT` |
| Reserved Range | `RPT-000600 – RPT-000699` |
| Next Free ID | **RPT-000600** |
