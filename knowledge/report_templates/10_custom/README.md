# Custom — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Custom**.
...
Provide a stable domain boundary for **Custom** so authors can:
...
- Report template scaffolding for Custom audience/theme
...
- This domain owns only **Custom** framework placement under `knowledge/report_templates/10_custom/`.
