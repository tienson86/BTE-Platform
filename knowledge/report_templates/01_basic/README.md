# Basic — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Basic**.
...
Provide a stable domain boundary for **Basic** so authors can:
...
- Report template scaffolding for Basic audience/theme
...
- This domain owns only **Basic** framework placement under `knowledge/report_templates/01_basic/`.
...
|-------|-------|
| ID Prefix | `RPT` |
| Reserved Range | `RPT-000001 – RPT-000099` |
| Next Free ID | **RPT-000001** |
