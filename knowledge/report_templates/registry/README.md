# Report Registry — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Report Registry**.
...
Provide a stable domain boundary for **Report Registry** so authors can:
...
- Locator rows for Report Templates across domains
...
- Root specification: `knowledge/report_templates/REPORT_TEMPLATE_SPEC.md`
- All Report Template domain indexes
...
- This domain owns only **Report Registry** framework placement under `knowledge/report_templates/registry/`.
