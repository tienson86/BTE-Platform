# Health — Report Template Framework Domain
...
It holds indexes and templates for future `RPT` records related to **Health**.
...
Provide a stable domain boundary for **Health** so authors can:
...
- Report template scaffolding for Health audience/theme
...
- This domain owns only **Health** framework placement under `knowledge/report_templates/06_health/`.
