# Professional — Report Template Framework Domain

**Module:** `knowledge/report_templates`  
**Domain:** `02_professional`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `RPT` records related to **Professional**.
...
Provide a stable domain boundary for **Professional** so authors can:
...
- Report template scaffolding for Professional audience/theme
...
- This domain owns only **Professional** framework placement under `knowledge/report_templates/02_professional/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `02_professional` |
...
|-------|-------|
| ID Prefix | `RPT` |
| Reserved Range | `RPT-000100 – RPT-000199` |
| Next Free ID | **RPT-000100** |
