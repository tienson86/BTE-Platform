...
| Field | Value |
|-------|-------|
| Rule | Every major call: Accepted / Rejected / Deferred + why |
...
| Date | Decision | Rationale |
|------|----------|-----------|
| 2026-08-13 | **Persona Engine V2** | Discovery P04+P05+P06: recurring *delivery* need; P05 already passes on OPERATING_OUTPUT; engine would duplicate Product Context + CDR. **PB-R01** |
| 2026-08-13 | **Strength-band engine fix** (0.50→weak / RV-004) | ~0 paying CX; frozen Truth; skip. **PB-R02** |
| 2026-08-13 | **New Knowledge rule** for thân vs pattern split | BETA-0007 WONTFIX. **PB-R03** |
| 2026-08-13 | One template pack per P01–P10 | Same as Persona Engine under another name. |
| 2026-08-13 | Unfreeze Golden / Quality Gates to match EPIC scores | Gates and Dataset stay frozen; product evidence lives in analytics + this board. |
