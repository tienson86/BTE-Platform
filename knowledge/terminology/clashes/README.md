# Clashes — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Clashes**.
...
- Official term scaffolding for Clashes
...
- This domain owns only **Clashes** framework placement under `knowledge/terminology/clashes/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-001000 – TERM-001099` |
| Next Free ID | **TERM-001000** |
