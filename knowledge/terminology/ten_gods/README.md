# Ten Gods — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Ten Gods**.
...
- Official term scaffolding for Ten Gods
...
- This domain owns only **Ten Gods** framework placement under `knowledge/terminology/ten_gods/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000500 – TERM-000599` |
| Next Free ID | **TERM-000500** |
