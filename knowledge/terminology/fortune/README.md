# Fortune — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Fortune**.
...
Provide a stable domain boundary for **Fortune** so authors can:
...
- Official term scaffolding for Fortune
...
- This domain owns only **Fortune** framework placement under `knowledge/terminology/fortune/`.
