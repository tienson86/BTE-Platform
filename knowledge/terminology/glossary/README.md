# Glossary — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Glossary**.
...
Provide a stable domain boundary for **Glossary** so authors can:
...
- Official term scaffolding for Glossary
...
- This domain owns only **Glossary** framework placement under `knowledge/terminology/glossary/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-001900 – TERM-001999` |
| Next Free ID | **TERM-001900** |
