# Astrology — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Astrology**.
...
Provide a stable domain boundary for **Astrology** so authors can:
...
- Official term scaffolding for Astrology
...
- This domain owns only **Astrology** framework placement under `knowledge/terminology/astrology/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-001800 – TERM-001899` |
| Next Free ID | **TERM-001800** |
