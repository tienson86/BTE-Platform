# Basic — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Basic**.
...
- Official term scaffolding for Basic
...
- This domain owns only **Basic** framework placement under `knowledge/terminology/basic/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000001 – TERM-000099` |
| Next Free ID | **TERM-000001** |
