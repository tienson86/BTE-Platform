# Combinations — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Combinations**.
...
- Official term scaffolding for Combinations
...
- This domain owns only **Combinations** framework placement under `knowledge/terminology/combinations/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000900 – TERM-000999` |
| Next Free ID | **TERM-000900** |
