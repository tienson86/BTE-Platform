# Transformations — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Transformations**.
...
- Official term scaffolding for Transformations
...
- This domain owns only **Transformations** framework placement under `knowledge/terminology/transformations/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `transformations` |
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-001300 – TERM-001399` |
| Next Free ID | **TERM-001300** |
