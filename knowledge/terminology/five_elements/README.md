# Five Elements — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Five Elements**.
...
- Official term scaffolding for Five Elements
...
- This domain owns only **Five Elements** framework placement under `knowledge/terminology/five_elements/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `five_elements` |
