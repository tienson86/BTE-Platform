# Shensha — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Shensha**.
...
- Official term scaffolding for Shensha
...
- This domain owns only **Shensha** framework placement under `knowledge/terminology/shensha/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-001400 – TERM-001599` |
| Next Free ID | **TERM-001400** |
