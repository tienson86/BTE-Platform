# Hidden Stems — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Hidden Stems**.
...
- Official term scaffolding for Hidden Stems
...
- This domain owns only **Hidden Stems** framework placement under `knowledge/terminology/hidden_stems/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000300 – TERM-000399` |
| Next Free ID | **TERM-000300** |
