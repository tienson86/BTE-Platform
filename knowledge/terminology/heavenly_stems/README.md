# Heavenly Stems — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Heavenly Stems**.
...
- Official term scaffolding for Heavenly Stems
...
- This domain owns only **Heavenly Stems** framework placement under `knowledge/terminology/heavenly_stems/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `heavenly_stems` |
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000100 – TERM-000199` |
| Next Free ID | **TERM-000100** |
