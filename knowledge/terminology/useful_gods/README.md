# Useful Gods — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Useful Gods**.
...
- Official term scaffolding for Useful Gods
...
- This domain owns only **Useful Gods** framework placement under `knowledge/terminology/useful_gods/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000800 – TERM-000899` |
| Next Free ID | **TERM-000800** |
