# Punishments — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Punishments**.
...
- Official term scaffolding for Punishments
...
- This domain owns only **Punishments** framework placement under `knowledge/terminology/punishments/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-001100 – TERM-001199` |
| Next Free ID | **TERM-001100** |
