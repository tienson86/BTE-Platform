# Earthly Branches — Terminology Framework Domain

**Module:** `knowledge/terminology`  
**Domain:** `earthly_branches`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `TERM` records related to **Earthly Branches**.
...
- Official term scaffolding for Earthly Branches
...
- This domain owns only **Earthly Branches** framework placement under `knowledge/terminology/earthly_branches/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `earthly_branches` |
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000200 – TERM-000299` |
| Next Free ID | **TERM-000200** |
