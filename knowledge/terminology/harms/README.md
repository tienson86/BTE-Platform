# Harms — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Harms**.
...
- Official term scaffolding for Harms
...
- This domain owns only **Harms** framework placement under `knowledge/terminology/harms/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-001200 – TERM-001299` |
| Next Free ID | **TERM-001200** |
