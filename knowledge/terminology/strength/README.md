# Strength — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Strength**.
...
- Official term scaffolding for Strength
...
- This domain owns only **Strength** framework placement under `knowledge/terminology/strength/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000600 – TERM-000699` |
| Next Free ID | **TERM-000600** |
