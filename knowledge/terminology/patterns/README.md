# Patterns — Terminology Framework Domain
...
It holds indexes and templates for future `TERM` records related to **Patterns**.
...
- Official term scaffolding for Patterns
...
- This domain owns only **Patterns** framework placement under `knowledge/terminology/patterns/`.
...
|-------|-------|
| ID Prefix | `TERM` |
| Reserved Range | `TERM-000700 – TERM-000799` |
| Next Free ID | **TERM-000700** |
