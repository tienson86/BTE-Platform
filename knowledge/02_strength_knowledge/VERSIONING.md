...
This document defines versioning and compatibility policy for Strength Knowledge.
...
| Increment | Meaning |
|-----------|---------|
| MAJOR | Breaking strength semantics or incompatible contracts |
...
- Strength Engine consumer range
