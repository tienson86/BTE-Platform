...
This document defines governance for Strength Knowledge.
...
| Subject | Owner |
|---------|-------|
| Strength Knowledge | Strength Domain Owner |
| Fundamental references | Fundamental Domain Owner |
| Strength Engine | Strength Engine Owner |
...
- complete V1.0 strength domain coverage
...
- dataset updates
- Strength Engine consumer notification plan

---

# 8. Compatibility Policy

Strength Knowledge shall remain compatible with declared Fundamental Knowledge and Strength Engine ranges, or explicitly increment MAJOR when incompatible.
