...
This document defines versioning and compatibility policy for Ten Gods Knowledge.
...
| Increment | Meaning |
|-----------|---------|
| MAJOR | Breaking Ten Gods semantics or incompatible contracts |
...
- Ten Gods Engine consumer range
- evidence-compatibility expectations for Strength / Pattern / Useful God published classifications
