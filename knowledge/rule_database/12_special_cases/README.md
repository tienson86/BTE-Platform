# Special Cases — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Special Cases**.
...
- Rule scaffolding for Special Cases decisions
...
- This domain owns only **Special Cases** framework placement under `knowledge/rule_database/12_special_cases/`.
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-001200 – RUL-001299` |
| Next Free ID | **RUL-001200** |
