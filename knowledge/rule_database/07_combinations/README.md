# Combinations — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Combinations**.
...
- Rule scaffolding for Combinations decisions
...
- This domain owns only **Combinations** framework placement under `knowledge/rule_database/07_combinations/`.
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000600 – RUL-000699` |
| Next Free ID | **RUL-000600** |
