# Strength — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Strength**.
...
- Rule scaffolding for Strength decisions
...
- This domain owns only **Strength** framework placement under `knowledge/rule_database/01_strength/`.
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000001 – RUL-000099` |
| Next Free ID | **RUL-000001** |
