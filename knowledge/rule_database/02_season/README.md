# Season — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Season**.
...
Provide a stable domain boundary for **Season** so authors can:
...
- Rule scaffolding for Season decisions
...
- This domain owns only **Season** framework placement under `knowledge/rule_database/02_season/`.
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000100 – RUL-000199` |
| Next Free ID | **RUL-000100** |
