# Useful Gods — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Useful Gods**.
...
- Rule scaffolding for Useful Gods decisions
...
- This domain owns only **Useful Gods** framework placement under `knowledge/rule_database/05_useful_gods/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `05_useful_gods` |
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000400 – RUL-000499` |
| Next Free ID | **RUL-000400** |
