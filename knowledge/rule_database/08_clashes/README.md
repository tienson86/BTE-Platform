# Clashes — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Clashes**.
...
- Rule scaffolding for Clashes decisions
...
- This domain owns only **Clashes** framework placement under `knowledge/rule_database/08_clashes/`.
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000700 – RUL-000799` |
| Next Free ID | **RUL-000700** |
