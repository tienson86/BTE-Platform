# Shensha — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Shensha**.
...
- Rule scaffolding for Shensha decisions
...
- This domain owns only **Shensha** framework placement under `knowledge/rule_database/10_shensha/`.
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000900 – RUL-001099` |
| Next Free ID | **RUL-000900** |
