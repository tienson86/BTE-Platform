# Ten Gods — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Ten Gods**.
...
- Rule scaffolding for Ten Gods decisions
...
- This domain owns only **Ten Gods** framework placement under `knowledge/rule_database/06_ten_gods/`.
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000500 – RUL-000599` |
| Next Free ID | **RUL-000500** |
