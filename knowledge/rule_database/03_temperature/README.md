# Temperature — Rule Database Framework Domain

**Module:** `knowledge/rule_database`  
**Domain:** `03_temperature`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `RUL` records related to **Temperature**.
...
- Rule scaffolding for Temperature decisions
...
- This domain owns only **Temperature** framework placement under `knowledge/rule_database/03_temperature/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `03_temperature` |
...
|-------|-------|
| ID Prefix | `RUL` |
| Reserved Range | `RUL-000200 – RUL-000299` |
| Next Free ID | **RUL-000200** |
