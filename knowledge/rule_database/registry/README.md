# Rule Registry — Rule Database Framework Domain
...
It holds indexes and templates for future `RUL` records related to **Rule Registry**.
...
Provide a stable domain boundary for **Rule Registry** so authors can:
...
- Locator rows for Rules across framework domains
...
- Root specification: `knowledge/rule_database/RULE_DATABASE_SPEC.md`
- All Rule Database framework domain indexes
...
- This domain owns only **Rule Registry** framework placement under `knowledge/rule_database/registry/`.
