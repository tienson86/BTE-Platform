# Pattern Knowledge Quality Standard
...
This document defines measurable quality criteria for Pattern Knowledge.
...
| Criterion | Focus |
|-----------|-------|
| Coverage | All V1.0 pattern dimensions and term families are populated |
...
Pattern Engine must not hard-code patches for defective pattern knowledge.
