...
This document defines versioning and compatibility policy for Pattern Knowledge.
...
| Increment | Meaning |
|-----------|---------|
| MAJOR | Breaking pattern semantics or incompatible contracts |
