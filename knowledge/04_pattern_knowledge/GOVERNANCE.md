...
This document defines governance for Pattern Knowledge.
...
| Subject | Owner |
|---------|-------|
| Pattern Knowledge | Pattern Domain Owner |
| Fundamental references | Fundamental Domain Owner |
| Pattern Engine | Pattern Engine Owner |
...
- dataset updates
- Pattern Engine consumer notification plan

---

# 8. Compatibility Policy

Pattern Knowledge shall remain compatible with declared Fundamental Knowledge and Pattern Engine ranges, or explicitly increment MAJOR when incompatible.
