# Modern — Reference Library Domain
...
It holds indexes and templates for future `REF` records related to **Modern**.
...
Provide a stable domain boundary for **Modern** so authors can:
...
- Modern book/monograph scaffolding
...
- This domain owns only **Modern** framework placement under `knowledge/references/modern/`.
