# Papers — Reference Library Domain
...
It holds indexes and templates for future `REF` records related to **Papers**.
...
Provide a stable domain boundary for **Papers** so authors can:
...
- This domain owns only **Papers** framework placement under `knowledge/references/papers/`.
