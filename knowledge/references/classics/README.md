# Classics — Reference Library Domain
...
It holds indexes and templates for future `REF` records related to **Classics**.
...
Provide a stable domain boundary for **Classics** so authors can:
...
- Classical reference scaffolding
- Metadata and index placeholders for classics
...
- This domain owns only **Classics** framework placement under `knowledge/references/classics/`.
...
|-------|-------|
| ID Prefix | `REF` |
| Reserved Range | `REF-000001 – REF-000099` |
| Next Free ID | **REF-000011** |
