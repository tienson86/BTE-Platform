# Combination Knowledge Quality Standard
...
This document defines measurable quality criteria for Combination Knowledge.
...
| Criterion | Focus |
|-----------|-------|
| Coverage | All V1.0 Combination dimensions and term families are populated |
...
Combination Engine must not hard-code patches for defective Combination knowledge.
