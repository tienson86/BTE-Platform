# Shensha — Golden Dataset Framework Domain
...
It holds indexes and templates for future `CASE` records related to **Shensha**.
...
- Golden case scaffolding for Shensha
...
- This domain owns only **Shensha** framework placement under `knowledge/golden_dataset/08_shensha/`.
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-000700 – CASE-000899` |
| Next Free ID | **CASE-000700** |
