# Basic — Golden Dataset Framework Domain
...
It holds indexes and templates for future `CASE` records related to **Basic**.
...
- Golden case scaffolding for Basic
...
- This domain owns only **Basic** framework placement under `knowledge/golden_dataset/01_basic/`.
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-000001 – CASE-000099` |
| Next Free ID | **CASE-000001** |
