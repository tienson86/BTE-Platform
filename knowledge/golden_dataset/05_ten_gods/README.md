# Ten Gods — Golden Dataset Framework Domain
...
It holds indexes and templates for future `CASE` records related to **Ten Gods**.
...
- Golden case scaffolding for Ten Gods
...
- This domain owns only **Ten Gods** framework placement under `knowledge/golden_dataset/05_ten_gods/`.
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-000400 – CASE-000499` |
| Next Free ID | **CASE-000400** |
