# Strength — Golden Dataset Framework Domain
...
It holds indexes and templates for future `CASE` records related to **Strength**.
...
- Golden case scaffolding for Strength
...
- This domain owns only **Strength** framework placement under `knowledge/golden_dataset/02_strength/`.
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-000100 – CASE-000199` |
| Next Free ID | **CASE-000100** |
