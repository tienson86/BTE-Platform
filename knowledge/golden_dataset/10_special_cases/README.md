# Special Cases — Golden Dataset Framework Domain
...
It holds indexes and templates for future `CASE` records related to **Special Cases**.
...
- Golden case scaffolding for Special Cases
...
- This domain owns only **Special Cases** framework placement under `knowledge/golden_dataset/10_special_cases/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `10_special_cases` |
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-001000 – CASE-001099` |
| Next Free ID | **CASE-001000** |
