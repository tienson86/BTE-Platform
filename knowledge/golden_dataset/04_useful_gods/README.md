# Useful Gods — Golden Dataset Framework Domain

**Module:** `knowledge/golden_dataset`  
**Domain:** `04_useful_gods`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `CASE` records related to **Useful Gods**.
...
- Golden case scaffolding for Useful Gods
...
- This domain owns only **Useful Gods** framework placement under `knowledge/golden_dataset/04_useful_gods/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `04_useful_gods` |
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-000300 – CASE-000399` |
| Next Free ID | **CASE-000300** |
