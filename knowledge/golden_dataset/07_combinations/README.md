# Combinations — Golden Dataset Framework Domain

**Module:** `knowledge/golden_dataset`  
**Domain:** `07_combinations`  
**Version:** V1.0.0  
...
It holds indexes and templates for future `CASE` records related to **Combinations**.
...
- Golden case scaffolding for Combinations
...
- This domain owns only **Combinations** framework placement under `knowledge/golden_dataset/07_combinations/`.
...
| Item | Convention |
|------|------------|
| Domain directory | `07_combinations` |
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-000600 – CASE-000699` |
| Next Free ID | **CASE-000600** |
