# Patterns — Golden Dataset Framework Domain
...
It holds indexes and templates for future `CASE` records related to **Patterns**.
...
- Golden case scaffolding for Patterns
...
- This domain owns only **Patterns** framework placement under `knowledge/golden_dataset/03_patterns/`.
...
|-------|-------|
| ID Prefix | `CASE` |
| Reserved Range | `CASE-000200 – CASE-000299` |
| Next Free ID | **CASE-000200** |
