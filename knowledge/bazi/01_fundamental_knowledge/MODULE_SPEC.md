# Module Specification — Fundamental Knowledge
...
Core BaZi conceptual foundations used by downstream BaZi knowledge modules.

---

## 2. Knowledge boundaries

This module MAY eventually contain Knowledge Records about **Fundamental Knowledge** topics within BaZi practice.
...
|-------------|------------------|
| Record inventory | Present: `KNOWLEDGE_INVENTORY.md` (Phase 1) |
