"""P7-IMP-09 live proof: Domain Interpretation, /result, diagnostics."""
...
def main() -> None:
    ...
    try:
        ...
        overview = SHOTS / "p7_imp_09_result_overview.png"
        summary = SHOTS / "p7_imp_09_domain_summary.png"
        mobile = SHOTS / "p7_imp_09_mobile_domain_summary.png"
        diag_shot = SHOTS / "p7_imp_09_diagnostics.png"
        expanded: dict[str, Path] = {
            domain_id: SHOTS / f"p7_imp_09_{domain_id}_expanded.png" for domain_id in DOMAIN_IDS
        }
        ...
        if not isinstance(domains, dict) or not domains.get("items"):
        ...
        (OUT / "P7-IMP-09_diagnostics.json").write_text(
