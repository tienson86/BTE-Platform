"""TV-01 Language Pack binding seam. Key map only. No Marriage package imports."""

from __future__ import annotations

from typing import Final

# Frozen R02 Assessment.semantic_key → approved Language Pack key.
R02_SEMANTIC_TO_LANGUAGE_KEY: Final[dict[tuple[str, str], str]] = {
    ...
    ("Q3", "conflict"): "marriage.q3.conflicting_temperament",
    ("Q3", "different"): "marriage.q3.balanced",
    ("Q4", "stable_with_rescue"): "marriage.q4.stable_with_rescue",
    ("Q4", "stable_if_kept"): "marriage.q4.stable",
    ...
    ("Q6", "insufficient"): "marriage.q6.insufficient",
}
