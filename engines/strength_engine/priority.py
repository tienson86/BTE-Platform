"""Priority resolution for Strength Engine."""
...
class StrengthPriorityResolver:
    ...
    def __init__(self, priority_rules: list[dict[str, Any]]) -> None:
        ...
        self._group_map.setdefault("season", 95)
        self._group_map.setdefault("root", 90)
        self._group_map.setdefault("support", 85)
        self._group_map.setdefault("control", 80)
        self._group_map.setdefault("drain", 75)
        self._group_map.setdefault("combination", 70)
    ...
    def resolve_level(
        ...
        """Pick winning level rule after strength_score is computed."""
