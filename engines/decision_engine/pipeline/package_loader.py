"""Load released Decision Knowledge Packages. Read-only."""
...
from engines.decision_engine.exceptions import IncompatiblePackageError, PackageLoadError

logger = logging.getLogger(__name__)

REQUIRED_SCHEMA_VERSION = "2.0.0"
_PACKAGE_RELATIVE_ROOTS: dict[str, tuple[str, ...]] = {
    "bz_06_useful_god_foundation": ("knowledge", "packages", "useful_god", "foundation"),
    "bz_07_useful_god_priority": ("knowledge", "packages", "useful_god", "priority"),
    "bz_08_useful_god_override": ("knowledge", "packages", "useful_god", "override"),
}
...
class LoadedPackage:
    """Immutable snapshot of a released decision package."""
...
class DecisionPackageLoader:
    """Load and admit released Useful God decision packages."""
    ...
    def load(
        ...
        *,
        ...
        logger.debug(
            "decision_package_loaded",
            extra={"package_id": loaded.package_id, "package_version": loaded.package_version},
        )
        return loaded
    ...
    def assert_optional_dependencies(self, loaded: Mapping[str, LoadedPackage]) -> None:
        """Check optional peer constraints among co-loaded packages."""
