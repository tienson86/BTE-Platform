...
This document defines caching strategy for the Combination Engine.

Caching must never alter Combination analytical semantics.
...
| Layer | Content | Notes |
|-------|---------|-------|
| Knowledge Cache | Combination Knowledge via SDK/Loader | Owned by Knowledge Loader; accessed through SDK |
