# Combination Engine Error Handling
...
This document defines error classification and handling for the Combination Engine.
...
| KnowledgeError | SDK resolve/load/get failure for Combination Knowledge |
...
- invent Combination outcomes without knowledge
- skip conflict resolution and publish incomplete success
...
No successful CombinationResult is returned on mandatory failure.
