...
This document defines validation requirements for Combination Engine execution.
...
Verify Knowledge SDK session provides load-eligible Combination Knowledge for the frozen request versions.
...
Verify stage readiness according to Analysis Runtime pipeline position (stage 06).

---

# 7. Intermediate Consistency Validation

Verify detected relations reference only legal stem/branch identities and declared knowledge mappings.

---

# 8. Result Schema Validation

Verify CombinationResult contains required structural fields and legal enumerations.
...
Mandatory validation failures raise classified errors and prevent successful CombinationResult publication.
