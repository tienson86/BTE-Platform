...
This document defines caching strategy for the Luck Engine.

Caching must never alter Luck analytical semantics.
...
| Layer | Content | Notes |
|-------|---------|-------|
| Knowledge Cache | Luck Knowledge via SDK/Loader | Owned by Knowledge Loader; accessed through SDK |
...
- Layer hierarchy must remain consistent regardless of cache hit/miss
