...
This document defines caching strategy for the Ten Gods Engine.

Caching must never alter Ten Gods analytical semantics.
...
| Layer | Content | Notes |
|-------|---------|-------|
| Knowledge Cache | Ten Gods Knowledge via SDK/Loader | Owned by Knowledge Loader; accessed through SDK |
