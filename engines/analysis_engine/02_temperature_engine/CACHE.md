# Temperature Engine Cache Strategy
...
This document defines the caching strategy for the Temperature Engine.
...
The Temperature Engine may cache only immutable resources.
...
StrengthResult shall never be cached as a mutable or engine-owned resource.
