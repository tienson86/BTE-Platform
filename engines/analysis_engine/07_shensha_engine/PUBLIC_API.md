...
This document defines the official public interface of the ShenSha Engine.
...
Failures surface as classified errors. No false-complete ShenShaResult on mandatory failure.

---

# 7. Compatibility

| Consumer | May consume ShenShaResult |
|----------|---------------------------|
