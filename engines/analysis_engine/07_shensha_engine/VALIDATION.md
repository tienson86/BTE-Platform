...
This document defines validation requirements for ShenSha Engine execution.
...
Verify Knowledge SDK session provides load-eligible ShenSha Knowledge for the frozen request versions.
...
Verify stage readiness according to Analysis Runtime pipeline position (stage 07).

---

# 7. Intermediate Consistency Validation

Verify detected ShenSha identities reference only declared knowledge mappings and legal chart anchors.

---

# 8. Result Schema Validation

Verify ShenShaResult contains required structural fields and legal enumerations.
...
Mandatory validation failures raise classified errors and prevent successful ShenShaResult publication.
