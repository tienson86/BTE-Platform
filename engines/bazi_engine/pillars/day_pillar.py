...
class DayPillarCalculator:
    ...
    def get_julian_day(
        ...
        """
        Julian Day Number (mốc trưa, số nguyên) cho Can Chi ngày.

        Dùng ngày dân sự của ``target_datetime`` (không lấy phần giờ)
        theo công thức tương đương Hồ Ngọc Đức.
        """
