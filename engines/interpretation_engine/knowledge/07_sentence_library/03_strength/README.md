...
Module `03_strength` định nghĩa khung Sentence Framework cho phần **Thân Vượng Nhược**.

Đây **không** phải nơi viết câu luận giải thật.
Đây **không** chứa Rule.
Chỉ cung cấp cấu trúc để Interpretation Engine chọn / compose câu thuộc nhóm `strength`.
...
- `sentence_id`: `strength_NNN` — ví dụ `strength_001`
...
| Trường | Giá trị |
|--------|---------|
| module_id | 03_strength |
| module_title | Thân Vượng Nhược |
| version | 1.0.0 |
