...
Module `10_health` định nghĩa khung Sentence Framework cho phần **Sức Khỏe**.

Đây **không** phải nơi viết câu luận giải thật.
Đây **không** chứa Rule.
Chỉ cung cấp cấu trúc để Interpretation Engine chọn / compose câu thuộc nhóm `health`.
...
- `sentence_id`: `health_NNN` — ví dụ `health_001`
