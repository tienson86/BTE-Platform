...
Module `09_relationship` định nghĩa khung Sentence Framework cho phần **Quan Hệ**.

Đây **không** phải nơi viết câu luận giải thật.
Đây **không** chứa Rule.
Chỉ cung cấp cấu trúc để Interpretation Engine chọn / compose câu thuộc nhóm `relationship`.
...
Rule Database
        ↓
Sentence Library / 09_relationship
        ↓
...
- `sentence_id`: `relationship_NNN` — ví dụ `relationship_001`
