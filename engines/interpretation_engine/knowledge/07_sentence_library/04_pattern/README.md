...
Module `04_pattern` định nghĩa khung Sentence Framework cho phần **Cách Cục**.

Đây **không** phải nơi viết câu luận giải thật.
Đây **không** chứa Rule.
Chỉ cung cấp cấu trúc để Interpretation Engine chọn / compose câu thuộc nhóm `pattern`.
...
- `sentence_id`: `pattern_NNN` — ví dụ `pattern_001`
...
| Trường | Giá trị |
|--------|---------|
| module_id | 04_pattern |
| module_title | Cách Cục |
| version | 1.0.0 |
