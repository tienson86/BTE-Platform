...
Module `08_wealth` định nghĩa khung Sentence Framework cho phần **Tài Chính**.

Đây **không** phải nơi viết câu luận giải thật.
Đây **không** chứa Rule.
Chỉ cung cấp cấu trúc để Interpretation Engine chọn / compose câu thuộc nhóm `wealth`.
...
- `sentence_id`: `wealth_NNN` — ví dụ `wealth_001`
