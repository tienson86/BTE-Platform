...
Module `07_career` định nghĩa khung Sentence Framework cho phần **Sự Nghiệp**.

Đây **không** phải nơi viết câu luận giải thật.
Đây **không** chứa Rule.
Chỉ cung cấp cấu trúc để Interpretation Engine chọn / compose câu thuộc nhóm `career`.
...
- `sentence_id`: `career_NNN` — ví dụ `career_001`
