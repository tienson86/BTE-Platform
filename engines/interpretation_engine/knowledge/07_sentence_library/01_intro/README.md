...
Module `01_intro` định nghĩa khung Sentence Framework cho phần **Mở Đầu**.

Đây **không** phải nơi viết câu luận giải thật.
Đây **không** chứa Rule.
Chỉ cung cấp cấu trúc để Interpretation Engine chọn / compose câu thuộc nhóm `intro`.
...
- `sentence_id`: `intro_NNN` — ví dụ `intro_001`
