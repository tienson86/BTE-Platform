...
class CommercialPlaywrightPdfBackend(PlaywrightPdfBackend):
    """PACK 05 Chromium print with compact consulting-report chrome."""

    def html_to_pdf(self, html: str, output_path: Path, *, title: str) -> int | None:
        """Print HTML to A4 PDF with a small footer."""
...
class DateSelectionPdfExporter:
    ...
    def __init__(self, *, backend: PdfBackend | None = None) -> None:
        self._backend = backend or CommercialPlaywrightPdfBackend()
